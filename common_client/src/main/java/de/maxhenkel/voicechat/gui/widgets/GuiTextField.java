...
public class GuiTextField extends Gui {
    ...
    public void setCursorPosition(int pos)
    {
        ...
        this.cursorPosition = MathHelper2.clamp(this.cursorPosition, 0, i);
    ...
    public void setFocused(boolean isFocusedIn)
    {
        ...
        {
            //MinecraftAccessor.getMinecraft().currentScreen.setFocused(isFocusedIn);
        }
    }
    ...
    public void setSelectionPos(int position)
    {
        ...
        if (this.fontRenderer != null)
        {
            ...
            this.lineScrollOffset = MathHelper2.clamp(this.lineScrollOffset, 0, i);
        }
    }
