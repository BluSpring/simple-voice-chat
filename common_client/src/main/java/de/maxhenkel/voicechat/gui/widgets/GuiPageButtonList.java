...
public class GuiPageButtonList extends GuiListExtended {
    ...
    public void onKeyPressed(char p_178062_1_, int p_178062_2_)
    {
        if (this.focusedControl instanceof GuiTextField)
        {
            ...
            if (!GuiTextField.isKeyComboCtrlV(p_178062_2_))
            {
                if (p_178062_2_ == 15)
                {
                    ...
                    if (GuiTextField.isShiftKeyDown())
                    {
                        if (k == 0)
                        {
    ...
    {
        private final GuiSliderModern.FormatHelper formatter;
        private final float minValue;
        private final float maxValue;
        private final float initialValue;

        public GuiSlideEntry(int p_i45530_1_, String p_i45530_2_, boolean p_i45530_3_, GuiSliderModern.FormatHelper p_i45530_4_, float p_i45530_5_, float p_i45530_6_, float p_i45530_7_)
        {
        ...
        public GuiSliderModern.FormatHelper getFormatter()
        {
